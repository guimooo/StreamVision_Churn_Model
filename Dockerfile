# ─────────────────────────────────────────────
# Container Principal — API de Previsão de Churn
# FastAPI + XGBoost (Python 3.13)
# ─────────────────────────────────────────────
FROM python:3.13-slim

# Metadados da imagem
LABEL maintainer="gms.gui84@gmail.com"
LABEL description="API de previsão de churn com FastAPI e XGBoost"
LABEL version="1.0"
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    PYTHONUNBUFFERED=1 \
    MODEL_PATH=/app/modelo_churn.pkl \
    APP_PORT=8000
